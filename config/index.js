...
export const VK = 'Ссылка на Вконтакте'
export const SITE = 'http://www.souyz-makets.ru'
export const COORDS = { lat: 53.180328, lng: 50.191435 }
export const BASEMAP = 'https://{s}.tile.osm.org/{z}/{x}/{y}.png'
